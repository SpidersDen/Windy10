...
Function Invoke-WPFFormVariables {
    ...
    Write-Host ""
    Write-Host " EEEEEEEEEEEEEEEEEEEEEE     VVVVVVVV           VVVVVVVV     NNNNNNNN        NNNNNNNN"     
    Write-Host " E::::::::::::::::::::E     V::::::V           V::::::V     N:::::::N       N::::::N"
    Write-Host " E::::::::::::::::::::E     V::::::V           V::::::V     N::::::::N      N::::::N"
    Write-Host " EE::::::EEEEEEEEE::::E     V::::::V           V::::::V     N:::::::::N     N::::::N"
    Write-Host "   E:::::E       EEEEEE      V:::::V           V:::::V      N::::::::::N    N::::::N"
    Write-Host "   E:::::E                    V:::::V         V:::::V       N:::::::::::N   N::::::N"
    Write-Host "   E::::::EEEEEEEEEE           V:::::V       V:::::V        N:::::::N::::N  N::::::N"
    Write-Host "   E:::::::::::::::E            V:::::V     V:::::V         N::::::N N::::N N::::::N"
    Write-Host "   E:::::::::::::::E             V:::::V   V:::::V          N::::::N  N::::N:::::::N"
    Write-Host "   E::::::EEEEEEEEEE              V:::::V V:::::V           N::::::N   N:::::::::::N"
    Write-Host "   E:::::E                         V:::::V:::::V            N::::::N    N::::::::::N"
    Write-Host "   E:::::E       EEEEEE             V:::::::::V             N::::::N     N:::::::::N"
    Write-Host "   EE::::::EEEEEEEE:::::E            V:::::::V              N::::::N      N::::::::N"
    Write-Host "   E::::::::::::::::::::E             V:::::V               N::::::N       N:::::::N"
    Write-Host "   E::::::::::::::::::::E              V:::V                N::::::N        N::::::N"
    Write-Host "   EEEEEEEEEEEEEEEEEEEEE                VVV                 NNNNNNNN         NNNNNNN"
    Write-Host ""
    Write-Host "==========Evn08========="
...
$inputXML = '<Window x:Class="WinUtility.MainWindow"
        ...
        Title="Evn08''s Windows Utility" Height="800" Width="1200">
    <Window.Resources>
        ...
        <Viewbox Stretch="Uniform" VerticalAlignment="Top">
            <Grid Background="#777777" ShowGridLines="False" Name="MainGrid">
                ...
                <DockPanel Background="#777777" SnapsToDevicePixels="True" Grid.Row="0" Width="1100">
                    <Image Height="50" Width="100" Name="Icon" SnapsToDevicePixels="True" Source="https://Evn08.com/images/logo-full.png" Margin="0,10,0,10"/>
...
$sync.configs.tweaks = '{
  ...
  "WPFEssTweaksOO": {
    "InvokeScript": [
      "curl.exe -s \"https://raw.githubusercontent.com/Evn08/winutil/main/ooshutup10.cfg\" -o $ENV:temp\\ooshutup10.cfg
  ...
  "WPFEssTweaksRemoveEdge": {
    "InvokeScript": [
      "Invoke-WebRequest -useb https://raw.githubusercontent.com/Evn08/winutil/main/Edge_Removal.bat | Invoke-Expression"
    ]
  },
